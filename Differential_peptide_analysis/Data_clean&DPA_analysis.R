...
# Load data ----
  raw <- read.xlsx(xlsxFile = "Differential_peptide_analysis/Input_data/with cetnred phosphosites Copy of ZR75-1FR tumor phosphoproteomics (Dec 2017)(9578) (1).xlsx", sheet = 1) 
  ...
  # 3d vs control
    ...
    # Heat map ----
        ...
        # Cluster raw phosphopeptide abundance data
          ...
          metadata <- read.csv("Differential_peptide_analysis/Input_data/metadata.csv", stringsAsFactors = FALSE, header = TRUE, row.names = 1)
